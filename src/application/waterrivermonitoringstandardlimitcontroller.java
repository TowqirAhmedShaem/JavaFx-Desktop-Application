...
public class waterrivermonitoringstandardlimitcontroller implements Initializable {
	@FXML
	...
	public waterrivermonitoringstandardlimitcontroller() throws SQLException {
		try {
	...
	public void actionidealsave(ActionEvent event) throws SQLException {
		...
		String deleteQuery = "delete from waterrivermonitoringstandarddatasave";
		stat.execute(deleteQuery);

		// //Adding into database
		String insertquery = "INSERT INTO waterrivermonitoringstandarddatasave (sampledate, subject, reference, signaturetemplate, description, idealph, idealec, idealts, idealtds, idealss, idealdo, idealcod, idealsalinity,  idealchloride, idealturbidity, idealtotalhardness, idealoilandgrease, idealbod,idealtemperature, remarks)"
				+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
