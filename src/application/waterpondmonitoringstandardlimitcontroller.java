...
public class waterpondmonitoringstandardlimitcontroller implements Initializable {
	@FXML
	...
	public waterpondmonitoringstandardlimitcontroller() throws SQLException {
		try {
	...
	public void actionidealsave(ActionEvent event) throws SQLException {
		...
		String deleteQuery = "delete from waterpondmonitoringstandarddatasave";
		stat.execute(deleteQuery);

		// //Adding into database
		String insertquery = "INSERT INTO waterpondmonitoringstandarddatasave (sampledate, subject, reference, signaturetemplate, description, idealph, idealec, idealts, idealtds, idealss, idealdo, idealcod, idealsalinity,  idealchloride, idealturbidity, idealtotalhardness, idealoilandgrease, idealbod,idealtemperature, remarks)"
				+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
