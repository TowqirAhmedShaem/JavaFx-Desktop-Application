...
public class waterseamonitoringstandardlimitcontroller implements Initializable {
	@FXML
	...
	public waterseamonitoringstandardlimitcontroller() throws SQLException {
		try {
	...
	public void actionidealsave(ActionEvent event) throws SQLException {
		...
		String deleteQuery = "delete from waterseamonitoringstandarddatasave";
		stat.execute(deleteQuery);

		// //Adding into database
		String insertquery = "INSERT INTO waterseamonitoringstandarddatasave (sampledate, subject, reference, signaturetemplate, description, idealph, idealec, idealts, idealtds, idealss, idealdo, idealcod, idealsalinity,  idealchloride, idealturbidity, idealtotalhardness, idealoilandgrease, idealbod,idealtemperature, remarks)"
				+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
