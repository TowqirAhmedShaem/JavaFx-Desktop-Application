...
public class airmonitoringstandardlimitcontroller implements Initializable {
	@FXML
	...
	public airmonitoringstandardlimitcontroller() throws SQLException {
		try {
	...
	public void actionidealsave(ActionEvent event) throws SQLException {
		...
		String deleteQuery = "delete from airmonitoringstandarddatasave";
		stat.execute(deleteQuery);

		// //Adding into database
		String insertquery = "INSERT INTO airmonitoringstandarddatasave (sampledate, subject, reference, signaturetemplate, description, idealspm,idealsox,idealnox,idealcox, remarks)"
				+ " VALUES (?,?,?,?,?,?,?,?,?,?)";
