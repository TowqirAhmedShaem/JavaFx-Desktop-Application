...
public class soundindustrystandardlimitcontroller implements Initializable {
	@FXML
	...
	public soundindustrystandardlimitcontroller() throws SQLException {
		try {
	...
	public void actionidealsave(ActionEvent event) throws SQLException {
		...
		String deleteQuery = "delete from soundindustrystandarddatasave";
		stat.execute(deleteQuery);

		// //Adding into database
		String insertquery = "INSERT INTO soundindustrystandarddatasave (sampledate, subject, reference, signaturetemplate, description, idealsoundlevel, remarks)"
				+ " VALUES (?,?,?,?,?,?,?)";
